      ...
      <div className="min-h-screen flex flex-col">
        ...
        <section className="container mx-auto px-4 py-20 md:py-32 min-h-screen flex items-center justify-center">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            {/*<div className="flex justify-center">*/}
            {/*  <div className="w-4/5 max-w-[520px] relative before:block before:pt-[100%]">*/}
            {/*    <div className="absolute inset-0 bg-primary/80 rounded-lg rotate-6 z-0"/>*/}
            {/*    <div className="absolute inset-0 bg-[#f5f2f2] rounded-lg flex items-center justify-center z-10">*/}
            {/*      <img*/}
            {/*          src={CypheronLogo}*/}
            {/*          alt="Cypheron Logo"*/}
